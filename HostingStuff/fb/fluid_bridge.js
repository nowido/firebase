...
FluidSink.prototype.onPacketOn = function(handler)
{
    this.packetOnHandler = handler;
}
...
FluidSink.prototype.listenPackets = function()
{
    var entry = this;
...
FluidSink.prototype.stopListenPackets = function(query)
{
    query.off('value');
}
...
FluidSink.prototype.cast = function(value)
{
    this.base.ref(this.key).set(value);    
}
